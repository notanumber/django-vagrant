...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "{{ project_name }}", "/home/vagrant/{{ project_name }}/{{ project_name }}"
  config.vm.synced_folder "requirements", "/home/vagrant/{{ project_name }}/requirements"
